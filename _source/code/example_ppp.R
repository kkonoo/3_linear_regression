...
plot(Inflation.difference,Exchange.rate.change,  main="Scatterplot of Exchange rate change vs Inflation difference",
     xlab="Inflation difference",ylab="Exchange rate change")
boxplot(Exchange.rate.change~as.factor(Developed), main="Boxplot of Exchange rate change by Developed vs 
...
attach(newppp)
par(mfrow=c(1,1))
plot(Inflation.difference,Exchange.rate.change, main="Scatterplot of Exchange rate change 
...
attach(newppp)
developed = newppp[Developed==1,] #20 developed countries
developing = newppp[Developed==0,] #20 developing countries
...
par(mfrow=c(2,2))
plot(Inflation.difference, residuals(pppb),xlab="Inflation Difference",ylab="Residuals",main="Versus Predictor")
abline(h=0,lty=2)
...
par(mfrow=c(2,2))
plot(Inflation.difference, residuals(pppc),xlab="Inflation Difference",ylab="Residuals",main="Versus Predictor")
abline(h=0,lty=2)
...
par(mfrow=c(2,2))
plot(Inflation.difference, residuals(pppd),xlab="Inflation Difference",ylab="Residuals",main="Versus Predictor")
abline(h=0,lty=2)
